    ...
    return (
      ...
      >
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-foreground">{t.checklist.sections.entradaPasillos.title}</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-sm font-semibold text-foreground">
              {t.checklist.sections.entradaPasillos.cuadroGeneralElectrico.title} <span className="text-red-500">*</span>
            </h2>
          ...
          <div className="space-y-2">
            <h2 className="text-sm font-semibold text-foreground">
              {t.checklist.sections.entradaPasillos.entradaViviendaPasillos.title} <span className="text-red-500">*</span>
            </h2>
            <div className="bg-card dark:bg-[var(--prophero-gray-900)] rounded-lg border p-6 shadow-sm">
              <Card className="p-6 space-y-4">
                <ChecklistUploadZoneComponent
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 space-y-4">
              <ChecklistQuestionComponent
                ...
                folder="checklist/entrada-pasillos"
              />
            </Card>
                    ...
                    <>
                      {hasMultipleUnits ? (
                            ...
                            return (
                              <div key={unit.id || index} className="space-y-4 border-l-2 pl-2 sm:pl-4 border-[var(--prophero-gray-200)] dark:border-[var(--prophero-gray-700)]">
                                <div className="text-xs sm:text-sm font-medium text-foreground leading-tight break-words">
                                  {t.checklist.sections.entradaPasillos.carpinteria.items[itemConfig.translationKey]} {index + 1} <span className="text-red-500">*</span>
                                </div>
                        ...
                        <>
                          <div className="space-y-2">
                            <div className="text-xs sm:text-sm font-medium text-foreground leading-tight break-words">
                              {t.checklist.sections.entradaPasillos.carpinteria.items[itemConfig.translationKey]} 1 <span className="text-red-500">*</span>
                            </div>
                          </div>
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                            {STATUS_OPTIONS.map((option) => {
                    ...
                    <>
                      {hasMultipleUnits ? (
                        ...
                        <div className="space-y-6">
                          {Array.from({ length: cantidad }, (_, index) => {
                            ...
                            return (
                              <div key={unit.id || index} className="space-y-4 border-l-2 pl-2 sm:pl-4 border-[var(--prophero-gray-200)] dark:border-[var(--prophero-gray-700)]">
                                <div className="text-xs sm:text-sm font-medium text-foreground leading-tight break-words">
                                  {t.checklist.sections.entradaPasillos.climatizacion.items[itemConfig.translationKey]} {index + 1} <span className="text-red-500">*</span>
                                </div>
                        ...
                        <>
                          <div className="space-y-2">
                            <div className="text-xs sm:text-sm font-medium text-foreground leading-tight break-words">
                              {t.checklist.sections.entradaPasillos.climatizacion.items[itemConfig.translationKey]} 1 <span className="text-red-500">*</span>
                            </div>
                          </div>
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                            {STATUS_OPTIONS.map((option) => {
