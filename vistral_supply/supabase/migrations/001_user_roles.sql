-- ============================================
-- Migración: Tabla user_roles para Supply app
...
CREATE TABLE IF NOT EXISTS user_roles (
  ...
  role TEXT NOT NULL CHECK (role IN ('supply_partner', 'supply_analyst', 'supply_admin')),
...
-- INSERT INTO user_roles (user_id, role) VALUES ('USER_ID', 'supply_partner');
