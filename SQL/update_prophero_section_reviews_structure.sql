-- Migration: Create/Update prophero_section_reviews field structure
-- Date: 2026-02-03
-- Description: Creates or updates the prophero_section_reviews field with new structure
--              including submittedComments, snapshot, and _meta fields

-- Add the column if it doesn't exist
ALTER TABLE properties 
ADD COLUMN IF NOT EXISTS prophero_section_reviews JSONB DEFAULT NULL;

-- Update the comment to document the new field structure
